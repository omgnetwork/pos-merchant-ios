...
class TopUpViewModelTests: XCTestCase {
    ...
    override func setUp() {
        ...
        self.sut = TopUpViewModel(tokenLoader: self.tokenLoader,
    ...
    func testDecodeValidString() {
        ...
        XCTAssertEqual(builder!.type, .topup)
        XCTAssertEqual(builder!.amount, "12")
        XCTAssertEqual(builder!.token, token)
        XCTAssertEqual(builder!.transactionRequestFormattedId, "123")
    }
